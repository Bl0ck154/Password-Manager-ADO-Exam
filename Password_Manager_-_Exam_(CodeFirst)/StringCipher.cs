...
namespace Password_Manager___Exam__CodeFirst_
{
	public static class StringCipher
	{
		...
		// This constant is using as default pass phrase.
		private const string defaultPassPhrase = "mySecretWord";
		...
		public static bool IsCrypted(string cipherText)
		{
			return (cipherText.Length == Keysize/2);
		}
